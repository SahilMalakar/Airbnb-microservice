...
('booking:read', 'Permission to read bookings', 'booking', 'read'),
...
('listing:read', 'Permission to read listings', 'listing', 'read'),
('listing:write', 'Permission to create/update listings', 'listing', 'write'),
('listing:delete', 'Permission to delete listings', 'listing', 'delete');
-- +goose StatementEnd
